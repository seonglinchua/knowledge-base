...
sidebar_label: Wealth Management
slug: /investments/wealth-management
---
...
1. Client onboarding — KYC, source of wealth documentation, CRS/FATCA classification
2. Client needs analysis — investment horizon, liquidity needs, risk tolerance (Customer Knowledge Assessment)
...
**Scenario**: SGD 2,000,000 Discretionary Portfolio — balanced mandate (60% bonds, 40% equities)
...
Annualised portfolio return (year 1) = 6.2%
Management fee = 0.75% p.a. on AUM = SGD 15,000/year
Net return to client = 5.45% p.a.
