---
id: rm-process
title: Relationship Manager Process
sidebar_label: RM Process
slug: /operations/rm-process
---
...
1. **Prospecting**: RM identifies potential client via referral, networking, or leads pipeline
2. **Initial meeting**: Client needs analysis — business profile, banking needs, financial position
3. **KYC documentation collection**: ACRA business profile, directors' IDs, shareholding structure, source of funds
4. **AML/KYC review**: Compliance team screens client against sanctions lists and performs EDD if required
